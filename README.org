...
图标： =doom-mode-line 4.0.0= 之后不再支持 =all-the-icons= 由 =nerd-icons= 代替：打开 [[https://www.nerdfonts.com/#home][nerdfont]] ，下载 =Symbols Nerd Font= 即可。
...
- [[https://github.com/company-mode/company-mode][company-mode]] 补全框架，最终用 cape.el + corfu 替换了
